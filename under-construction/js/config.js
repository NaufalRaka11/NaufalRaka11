// Configuration file – edit to personalize your under construction page
const CONFIG = {
  ...
  progressTarget: 78,
  // Notify button link (mailto, form, etc.)
  notifyUrl: "mailto:hello@example.com?subject=Notify%20me%20when%20ready"
};
